...
y = data["Temperature(℃)"].values  # ใช้ Wind Speed (mph) เป็น target
X = data.drop(columns=["Temperature(℃)"]).values.astype(float)  # ลบ Wind Speed ออกจาก X
...
model_path = r"C:\project2\Water_Use\model\21.00_model\21.00_temp.pkl"
