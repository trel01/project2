...
# โหลดข้อมูล
data = pd.read_csv(r"C:\project2\Water_Use\CSV2\21.00_weather.csv")
...
model_path = r"C:\project2\Water_Use\model2\21.00_modele2\21.00_weather.pkl"
...
# ถ้าคุณต้องการคำนวณค่า score หรือประเมินความแม่นยำ
print("Model Accuracy on Test Data:", model.score(X_test, y_test))  # ค่า R-squared
