...
# โหลดข้อมูล
data = pd.read_csv(r"C:\project2\Water_Use\CSV3\05.00_wind_speed.csv")
...
model_dir = r"C:\project2\Water_Use\model3\05.00_model3"  # แก้ไขให้ถูกต้อง
os.makedirs(model_dir, exist_ok=True)  # สร้างโฟลเดอร์ถ้ายังไม่มี

# บันทึกโมเดลด้วย pickle
model_path = os.path.join(model_dir, "05.00_wind_speed.pkl")  # แก้ไขชื่อไฟล์ให้ถูกต้อง
