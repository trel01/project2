...
# โหลดข้อมูล
data = pd.read_csv(r"C:\project2\Water_Use\CSV3\17.00_wind_speed.csv")
...
gbdt_model = GradientBoostingClassifier(n_estimators=100, learning_rate=0.1, max_depth=5, random_state=0)

# เทรนโมเดล
gbdt_model.fit(X_train, y_train)

# บันทึกโมเดลด้วย pickle
model_path = r"C:\project2\Water_Use\model3\17.00_model3\17.00_wind_speed.pkl"
