...
# โหลดข้อมูล
data = pd.read_csv(r"C:\project2\Water_Use\CSV3\21.00_humidity.csv")
...
model_dir = r"C:\project2\Water_Use\model3\21.00_model3"  # แก้ไขให้ถูกต้อง
os.makedirs(model_dir, exist_ok=True)  # สร้างโฟลเดอร์ถ้ายังไม่มี

# บันทึกโมเดลด้วย pickle
model_path = os.path.join(model_dir, "21.00_humidity.pkl")  # แก้ไขชื่อไฟล์ให้ถูกต้อง
